<template>
  <header class="z-10 bg-white py-4 shadow-md dark:bg-gray-800">
    <div class="container mx-auto flex h-full items-center justify-between px-6 text-purple-600 dark:text-purple-300">
      <!-- Mobile hamburger -->
      <button class="-ml-1 mr-5 rounded-md p-1 focus:shadow-outline-purple focus:outline-none md:hidden" aria-label="Menu">
      ...
      <ul class="flex flex-shrink-0 items-center space-x-6">
        <!-- Theme toggler -->
        <li class="flex">
          <button class="rounded-md focus:shadow-outline-purple focus:outline-none" aria-label="Toggle color mode" @click="toggleDarkMode">
        ...
        <!-- Notifications menu -->
        <li class="relative">
          <button class="relative rounded-md align-middle focus:shadow-outline-purple focus:outline-none" aria-label="Notifications" aria-haspopup="true">
            <svg class="h-5 w-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
        ...
        <!-- Profile menu -->
        <li class="relative">
          <button class="rounded-full align-middle focus:shadow-outline-purple focus:outline-none" aria-label="Account" aria-haspopup="true">
            <img
